 ...
 * Rend une voix française masculine très naturelle, quasi-humaine (fr-FR-HenriNeural),
 * sans aucune clé. En cas d'échec (réseau, blocage serveur), renvoie null →
 * Jarvis bascule automatiquement sur la voix synthétique du téléphone.
 *
    ...
    private fun ssmlMessage(text: String, voice: String): String {
        val ssml =
            "<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xml:lang='fr-FR'>" +
                "<voice name='$voice'>" +
                "<prosody rate='+3%' pitch='-2Hz'>${escape(text)}</prosody>" +
                "</voice></speak>"
